...
const dockVariants = cva(
  "supports-backdrop-blur:bg-white/10 supports-backdrop-blur:dark:bg-black/10 mx-auto mt-0 flex h-[50px] w-max items-center justify-center gap-6 rounded-2xl  p-0 backdrop-blur-md "
);
